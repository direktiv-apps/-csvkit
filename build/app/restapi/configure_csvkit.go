...
//go:generate swagger generate server --target ../../app --name Csvkit --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/csvkit/build/templates --principal interface{}

func configureFlags(api *operations.CsvkitAPI) {
...
func configureAPI(api *operations.CsvkitAPI) http.Handler {
